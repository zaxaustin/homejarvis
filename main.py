...
You have access to the following tools. When you believe a tool is necessary to answer a user's question, you must respond in the following format:
    ...
    def process_query(self, user_query):
        ...
        while True:
            ...
            if assistant_response.strip().startswith("TOOL:"):
                ...
                try:
                    # A simple, unsafe way to parse arguments.
                    ...
                    self.memory.add_message("assistant", f"TOOL: {tool_name}({args})")
