...
@tool
def analyze_desktop_screenshot(prompt_text: str) -> str:
    """
    Analyzes a screenshot of the user's desktop, located at 'desktop.png', and answers a question about it.
    Use this tool when the user asks a question about their desktop, screen, or what they are looking at.
    """
    image_path = "desktop.png"
    print(f"TOOL: Analyzing desktop screenshot at '{image_path}' with prompt: '{prompt_text}'...")
    try:
        ...
        return f"The desktop screenshot was not found. Please make sure you have saved a screenshot as 'desktop.png' in the project directory."
    except Exception as e:
